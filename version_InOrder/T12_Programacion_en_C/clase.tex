...
\begin{frame}[fragile,t]{Declaración de Funciones}
    ...
    \bigskip
    Existe una función distinguida de nombre \textbf{\texttt{main}} que es la principal en un programa C.\\
    \bigskip
...
\begin{frame}[fragile,t]{Estructuras de control\\ (\texttt{while})}
    ...
    \begin{textblock}{50}(5,20)
    \small
    Mientras la sentencia \texttt{condición}\\ se cumpla, es decir, sea verdadera,\\
...
% \begin{frame}[fragile,t]{Ejemplo}
% Calular un polinomio de grado 2.
% \begin{verbatim}
% float poli2(float x, float a, float b, float c) {
%     float term0 = c;
%     float term1 = b * x;
